...
export default function BugReportPage() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await axios.post("/api/mantox/imp/contact", {
        name,
        email,
        description
      });
      ...
      setError("Failed to send your query.");
    }
...
c-54 0 -102 -3 -105 -7z"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          <textarea
            placeholder="I have some questions abo..."
            value={description}
      ...
      <h2 className="mt-10 text-center font-bold">Or you can contact us through our socials</h2>
